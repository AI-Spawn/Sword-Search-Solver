...
swordsFile = "output.txt"
swordsFile = open(swordsFile, 'r')

swords = swordsFile.readlines()
swordCounter = 0
 #Ask for word to look for
while (True):
        #word = str(swords[swordCounter])
        word = adjust_word(swords[swordCounter])
